...
<body>
  ...
  <div class="container">
    ...
    <br/><br/><br/><br/>
    <center>
      <h1 class="adduser">Events</h1>
      <form action="eventsAdded.php">
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:&nbsp;&nbsp;&nbsp;<input type="text" name="username" placeholder="Event Name" class="mediuminput" required/></p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date:&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="username" placeholder="" class="mediuminput" required/></p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time:&nbsp;&nbsp;&nbsp;&nbsp;<input type="time" name="foopassword" placeholder="" class="shortinput" required/> &nbsp;- &nbsp;<input type="time" name="foopassword" placeholder="" class="shortinput" required/></p>
        <p>Representative:&nbsp;&nbsp;
